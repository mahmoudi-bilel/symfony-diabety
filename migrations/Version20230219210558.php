 ...
 */
final class Version20230219210558 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE publication ADD titre VARCHAR(255) NOT NULL, ADD numerodetel VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE publication DROP titre, DROP numerodetel');
    }
}
